...
class Config(object):
    ...
    ADMIN       = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '8206975901 6421803984 ').split()]
    FORCE_SUB_CHANNELS = os.environ.get('FORCE_SUB_CHANNELS', '-1003546877676').split(',')
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1003512136864"))
    DUMP_CHANNEL = int(os.environ.get("DUMP_CHANNEL", "-1003318903893"))
